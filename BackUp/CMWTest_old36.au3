...
Func TestReports()
	...
	#EndRegion -- Reports Test 1 - Verify reports are listed and descriptions show

	#Region -- Reports Test 2 - Verify report opens in cView and runs correctly

	ControlSend($g_wMain, "Launch Report", "TListBox1", "{Tab 2}{Space}")
	...
	#EndRegion -- Reports Test 2 - Verify report opens in cView and runs correctly
