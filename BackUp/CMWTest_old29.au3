...
Func TestImaging()
	...
	MouseClick("primary", $aiViewerPos[0] + 30, $aiViewerPos[1]+ 30)
	Sleep(250)
	ControlClick("Image Viewer", "", "TImageEnMView1", "primary", 1, 30, 30)
;	Sleep(5000)
;	ControlClick("Image Viewer", "", "TImageEnMView1", "primary", 3, 10, 10)
;	Sleep(5000)
;	ControlClick("Image Viewer", "", "TImageEnMView1", "primary", 2, 10, 10)
